							...
							return (
								...
								>
									...
									<div className="flex flex-col gap-0.5">
										...
										{(result.points ?? 0) > 0 && (
											<span className="text-lgsm font-kh text-amber-400">{result.points} pts</span>
										)}
										{result.gained_lost !== undefined && (
											<span className="text-sm font-kh text-muted-foreground">
												{result.gained_lost} pos
											</span>
										)}
									</div>
								</motion.div>
